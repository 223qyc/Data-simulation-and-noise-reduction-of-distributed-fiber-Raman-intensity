...
# 1.日志配置
def setup_logger():
    os.makedirs("DSDN-logs", exist_ok=True)
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"DSDN-logs/training_{current_time}.log"
...
LR = 0.001
BATCH_SIZE = 16
SAVE_PATH = "DSDN-saved_model/DSDN_best.pth"
